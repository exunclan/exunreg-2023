...
export default function Navbar({ Links }: { Links: Link[] }) {
  ...
  return (
    <>
      ...
      {/* Mobile view */}
      <div className="visible sm:hidden flex flex-row justify-between p-5 items-center">
        <Image src="/logo.png" alt="Exun Clan" width="137" height="52" />
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className={`${
            showMobile && "hidden"
          } h-6 w-6 inline-block lg:hidden cursor-pointer`}
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth={2}
...
const MobileNavbar = ({
  ...
  return (
    <div className="z-[2] fixed top-0 left-0 h-screen w-full bg-white/90">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-8 w-8 absolute top-9 right-12 text-main cursor-pointer"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
        strokeWidth={2}
      ...
      <div className="flex flex-col h-full justify-center items-center">
        ...
        <div className="text-main m-4 flex">
          <a
